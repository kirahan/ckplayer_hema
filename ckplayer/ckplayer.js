...
function ckstyle() { //定义总的风格
    var ck = {
		...
		*/
        ...
        setup: '1,0,1,1,1,2,0,1,2,0,0,1,200,0,2,1,0,0,1,1,2,10,3,0,1,0,3000,0,0,0,0,1,1,1,1,0,1,250,0,90,0,0,0',
        /*
		...
		*/
        cpt_share: 'http://aizhibo.tv/Public/ckplayer/share.xml',
        /*
		分享插件调用的配置文件地址
		调用插件开始
		*/
		cpt_barrage:'22,24,26|#FFFFFF,#ffe506,#ffece0,#FF83FA,#FF0000,#B2DFEE,#e0ebff|18,19,22,25|2,3,4|1',
		cpt_barrage_open:'0x606060,0x3d3d3d,0x000000,60,20,3',
		cpt_barrage_close:'0xfb8f03, 0xfb5503, 0x000000,60,20,3',
		cpt_barrage_release:'0xFFFFFF, 0xFFFFFF,0xFFFFFF,260,20,3',
        cpt_list: ckcpt()
        /*
